...
function notas_aleatorias($size) {  //creamos una funcion con parametro de entrada $size
        for($i=0; $i<$size; $i++)   //un bucle que seguira¡ activo mientras $i sea mas pequeño que el parametro de entrada señ±alado, empezando desde 0.
            {                       
...
notas_aleatorias(5);                //llamada a la funciÃ³n con parametro de entrada numero 5
?>
